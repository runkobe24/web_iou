...
define(function(require,exports,module) {
    ...
    var model = new Vue({
        ...
        computed: {
            validation: function() {
                return {
                    entName: !!this.company_name.trim(),
                    regNum: !!this.biz_license_no.trim(),
                    file: !!this.fileName.trim(),
                    lawName: !!this.legal_person_name.trim(),
                    idNum: !!this.legal_person_id.trim(),
                    selectAddress: this.value1 && this.value2 && this.value3,
                    phoneNum: !!this.biz_license_no.trim(),
                    detailAddress: !!this.compnay_location_detail.trim(),
                    phoneNum: !!this.office_tel.trim(),
                }
            },
            isValid: function() {
        ...
        methods:{
            verifyRegistrationNo : function () {
                this.$http({
                    url : baseUrl+'/iou/base/validateBusinessNo',
                    method : 'GET',
                    params : {
                        businessNo: model.biz_license_no
                    },
                    //emulateJSON:true
                }).then(
                    function (res) {
                ...
                this.showSuggestion.regNum = this.validation.regNum;
            },
            ...
            handleAvatarSuccess : function(res, file) {
                ...
                this.showSuggestion.file = this.validation.file;
            },
            beforeAvatarUpload : function(file) {
                const isValidForm = file.type === 'image/jpeg'|| file.type === 'image/png'|| file.type === 'image/jpg';
            ...
            authStep1 : function () {
                ...
                if(!model.isValid){
                    model.errorMsg='请完善企业信息';
                    model.showAlert();
                    return false;
                }else if(!model.licenseFlag){
                    model.errorMsg='请输入正确的营业执照注册号';
                    model.showAlert();
                    return false;
            ...
            companyNameValid: function() {
                this.showSuggestion.entName = this.validation.entName;
            },
            legalNameValid: function() {
                this.showSuggestion.lawName = this.validation.lawName;
            },
            legalIdValid: function() {
                this.showSuggestion.idNum = this.validation.idNum;
            },
            detailAddressValid: function() {
                this.showSuggestion.detailAddress = this.validation.detailAddress;
            },
            telephoneValid: function() {
                this.showSuggestion.phoneNum = this.validation.phoneNum;
            },
        }
    })
